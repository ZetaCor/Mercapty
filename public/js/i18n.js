...
const EN = {
  ...
  'En la app de Android': 'In the Android app',
  'Avisos de precio': 'Price alerts',
  'Te avisamos cuando baja algo de tu lista y en los días de descuento de los súper.': 'We’ll let you know when something in your list drops and on the stores’ discount days.',
  'La cámara y los avisos son de la app de Android, que estará pronto en Google Play. Lo demás funciona hoy mismo instalando Mercapty desde el navegador.': 'The camera and the alerts are part of the Android app, coming soon to Google Play. Everything else works today: just install Mercapty from your browser.',
