...
const EN: Record<string, string> = {
  ...
  'Arrastra hacia abajo y suelta para disparar': 'Drag down and let go to shoot',
  '{n} de {total}': '{n} of {total}',
  '{n} de {total} para ganarte un producto': '{n} of {total} to win a product',
  '¡Lo esquivó!': 'Dodged it!',
  'Te quedaste sin flechas. Tu récord es {n}.': 'You ran out of arrows. Your record is {n}.',
  '¡Llegaste a los {n}!': 'You made it to {n}!',
  'Te ganaste este producto:': 'You won this product:',
  'Escríbenos y te decimos qué producto te llevas.': 'Write to us and we will tell you which product you get.',
  'Reclamar por WhatsApp': 'Claim it on WhatsApp',
  '¡Hola! Llegué a {n} aciertos en el juego de Mercapty y quiero reclamar mi premio: {producto}.': 'Hi! I reached {n} hits in the Mercapty game and I would like to claim my prize: {producto}.',
  ...
  'Con el Programa 99+': 'With the 99+ program',
  'Con el Programa 99+. No aplica a productos de higiene': 'With the 99+ program. Not valid on hygiene products',
  'Con el Programa 99+. Solo las marcas de la lista': 'With the 99+ program. Selected brands only',
  ...
  'Los avisos llegan en la app instalada.': 'Alerts arrive in the installed app.',
