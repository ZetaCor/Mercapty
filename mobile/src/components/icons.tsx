...
const PATHS = {
  ...
  settings: (
    <>
      ...
      <Path d="M19.4 13.5a7.7 7.7 0 0 0 0-3l1.9-1.5-1.9-3.3-2.3.8a7.6 7.6 0 0 0-2.6-1.5L14.1 2.6H9.9l-.4 2.4a7.6 7.6 0 0 0-2.6 1.5l-2.3-.8-1.9 3.3 1.9 1.5a7.7 7.7 0 0 0 0 3l-1.9 1.5 1.9 3.3 2.3-.8a7.6 7.6 0 0 0 2.6 1.5l.4 2.4h4.2l.4-2.4a7.6 7.6 0 0 0 2.6-1.5l2.3.8 1.9-3.3z" />
    </>
  ),
  barcode: (
    <>
  ...
  game: (
    <>
      ...
      <Path d="M6.5 7h11a3.5 3.5 0 0 1 3.4 2.7l1 4.3A2.8 2.8 0 0 1 19 17.5c-1 0-1.6-.6-2.2-1.2L15.5 15h-7l-1.3 1.3c-.6.6-1.2 1.2-2.2 1.2a2.8 2.8 0 0 1-2.9-3.5l1-4.3A3.5 3.5 0 0 1 6.5 7z" />
  ...
  sun: (
    <>
      ...
      <Path d="M12 2.6v2.4M12 19v2.4M4.4 4.4l1.7 1.7M17.9 17.9l1.7 1.7M2.6 12H5M19 12h2.4M4.4 19.6l1.7-1.7M17.9 6.1l1.7-1.7" />
    </>
  ),
